...
export declare class TreeTable implements AfterContentInit, OnInit, OnDestroy, BlockableUI, OnChanges {
    ...
    constructor(document: Document, renderer: Renderer2, el: ElementRef, cd: ChangeDetectorRef, zone: NgZone, tableService: TreeTableService, filterService: FilterService, config: PrimeNGConfig);
